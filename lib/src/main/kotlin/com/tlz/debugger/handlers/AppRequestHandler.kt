...
import com.tlz.debugger.ConstUtils.FILTER
import com.tlz.debugger.ConstUtils.PAGE_INDEX
import com.tlz.debugger.ConstUtils.PAGE_SIZE
import com.tlz.debugger.ConstUtils.PKG
import com.tlz.debugger.ConstUtils.SEARCH
...
class AppRequestHandler(
	...
	private fun handleAppInfoRequest(session: NanoHTTPD.IHTTPSession): NanoHTTPD.Response =
			handleRequestSafely {
				responseData(com.tlz.debugger.models.Response(data = appManager.getApplicationInfoByPkg(session.parms[PKG]
						?: "")))
			}
