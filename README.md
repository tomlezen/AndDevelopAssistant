...
```
只需要在gradle文件中添加一下代码：
Gradle3.0以上： debugImplementation 'com.tlz.tools:AndDevelopAssistant:0.1.1'
Gradle3.0以下： debugCompile 'com.tlz.tools:AndDevelopAssistant:0.1.1'
非androidx版本:
Gradle3.0以上： debugImplementation 'com.tlz.tools:AndDevelopAssistant:0.1.1-no-x'
Gradle3.0以下： debugCompile 'com.tlz.tools:AndDevelopAssistant:0.1.1-no-x'
```
